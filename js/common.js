...
function showPrompt(title, msg, duration, args) {
    ...
    var event_0 = args[0].events ? args[0].events : function () {
    }, event_1 = typeof args[1] != 'undefined' ? args[1].events : function () {
    };
...
$(function () {
    ...
    //@ fold-title-头部，
    //@ fold-con-折叠内容 ，
    $(".fold-title").each(function () {
        $(this).click(function () {
            // var foldcon = $(this).next('.fold-con');
            var foldcon = $(this).siblings('.fold-con');
            foldcon.slideToggle();
